...
GO
PRINT N'Creating [dbo].[FileSystemTag]...';
...
ALTER TABLE [dbo].[SharedAccess]
    ADD DEFAULT (dateadd(day,(1),getdate())) FOR [ExpirationDate];
...
GO
ALTER TABLE [dbo].[FileSystem]
    ADD FOREIGN KEY ([UserId]) REFERENCES [dbo].[AspNetUsers] ([Id]) ON DELETE CASCADE;


GO
PRINT N'Creating unnamed constraint on [dbo].[FileSystemTag]...';


GO
ALTER TABLE [dbo].[FileSystemTag]
    ADD FOREIGN KEY ([FileSystemId]) REFERENCES [dbo].[FileSystem] ([Id]) ON DELETE CASCADE;
...
GO
PRINT N'Creating [dbo].[TR_FileSystem_DEL]...';
